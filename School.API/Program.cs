...
using SchoolApp.API.Infrastructure;
...
builder.Services.AddScoped<IClassesSectionsRepository, ClassesSectionsRepository>();
...
builder.Services.AddScoped<ClassSectionService>();
